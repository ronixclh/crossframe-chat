...
export default function ChatB() {
    ...
    useEffect(() => {
        const handleMessage = (event: MessageEvent) => {
            if (event.data?.type === "CHAT_MESSAGE" && event.data.from === "chat-a") {
            ...
            } else if (event.data?.type === "TYPING_INDICATOR" && event.data.from === "chat-a") {
    ...
    return (
        <div className="flex h-screen flex-col bg-gradient-to-br from-blue-50 via-green-50 to-teal-50">
            <Card className="flex flex-1 flex-col overflow-hidden rounded-none shadow-xl">
                <div className="border-b bg-gradient-to-r from-blue-600 to-green-600 p-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-bold text-white">Jordan Smith</h1>
                    ...
                    {messages.map((message) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <p className={`mt-1 text-xs ${message.sender === "self" ? "text-blue-100" : "text-gray-500"}`}>
                ...
                <div className="border-t bg-white p-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button
                            onClick={sendMessage}
                            size="icon"
                            className="shrink-0 bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700"
                        >
